...
<NavLink to = '/'><li className='m-2 cursor-pointer'>Home</li></NavLink>
    <NavLink to = '/lawyerDetails/:id'></NavLink>
    <NavLink to = '/My_Bookings'><li className='m-2 cursor-pointer'>My-Bookings</li></NavLink>
    <li className='m-2 cursor-pointer'>Blogs</li>
